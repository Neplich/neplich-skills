...
> [!IMPORTANT]
> 每次更新 `CLAUDE.md` 时，必须同步更新 `AGENTS.md`；每次更新 `AGENTS.md` 时，也必须同步更新 `CLAUDE.md`。两份文件内容必须保持一致。
...
- `CLAUDE.md` - Claude Code 仓库开发指南，修改时需同步更新 `AGENTS.md`
- `AGENTS.md` - 通用仓库开发指南，修改时需同步更新 `CLAUDE.md`
